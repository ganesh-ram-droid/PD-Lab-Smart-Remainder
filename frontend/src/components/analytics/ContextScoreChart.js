...
const ContextScoreChart = ({ data = [] }) => {
  ...
  return (
    <View className="rounded-3xl bg-white p-4 shadow-sm" style={{ shadowColor: '#0F172A' }}>
      <Text className="text-base font-bold text-slate-950">Context Score Trend</Text>
          ...
          return (
            <View key={item.label} className="flex-1 items-center px-1">
              <View className="h-28 w-full justify-end rounded-2xl bg-slate-50 p-1">
                <View className="rounded-xl bg-blue-600" style={{ height }} />
              </View>
...
export default ContextScoreChart;
